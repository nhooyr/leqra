...
with sync_playwright() as pw:
    ...
    page.wait_for_function("window.__test && leqra.version === '4.25.0'")
    ...
    check(page.evaluate('__test.online.serverVersion') == '4.25.0', 'Online connection completes the v4.23 version handshake')
...
report = {'version': '4.25.0', 'passed': len(checks), 'checks': checks, 'errors': errors}
