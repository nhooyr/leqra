...
function networkBoot(){
 ...
 Object.assign(s,{performance:{now:()=>s.now},round:1,roundClock:75,roundWinner:-1,scores:[],goUntil:0,phaseTime:0,gameStarted:true,
 ...
 s.sequence=[];const laserEffect=s.laserEffect;s.laserEffect=(...args)=>{s.sequence.push('laser:'+args[0]);return laserEffect(...args);};s.shotSound=kind=>s.sequence.push('shot:'+kind);s.boom=()=>s.sequence.push('hit');s.tone=()=>s.sequence.push('shield');
