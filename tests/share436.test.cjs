...
function boot({spectating=false,p2=true}={}){
 ...
 for(const name of ['shareLocalRoom','connectOnline','currentRules','pilotLoadoutTank','receiveOnlineState','netTank','showVersionMismatch'])vm.runInContext(declaration(name),s);
