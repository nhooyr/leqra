...
report={'version':'4.28.0','passed':len(checks),'checks':checks,'errors':errors,'note':'Safari identities executed in Chromium because Playwright WebKit could not be installed in this environment.'}
