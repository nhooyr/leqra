...
with sync_playwright() as pw:
 ...
 try:
  ...
  check(p.evaluate('leqra.version')=='3.9.0','Version 3.9.0 loads')
  ...
  report={'version':'3.9.0','passed':len(checks),'checks':checks,'errors':errors,'limits':'Chromium desktop/mobile emulation; real assets, synthetic URL/storage and deterministic stepping. No physical phones.'}
