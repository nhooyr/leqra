...
> remote-grenade behaviour, see **WEAPON-CONTROLS.md** and **POWERUPS.md**.
...
missile, grenade, super speed, and laser. See **POWERUPS.md** for the full set.
...
regression is one synthetic run, not a latency guarantee. See **TESTING.md**
