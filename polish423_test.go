...
func Test423VersionedPWAAssetsAndCaching(t *testing.T) {
	...
	for _, want := range []string{
		`assets/v4.23.0/game.js`, `assets/v4.23.0/theme.js`, `assets/v4.23.0/manifest.webmanifest`,
		`assets/v4.23.0/pwa.js`, `apple-mobile-web-app-capable`, `apple-touch-icon`,
	} {
	...
	for _, want := range []string{"leqra-app-", "v4.23.0", "'/ws'", "'/healthz'", "'/api/'", "caches.match('/')"} {
