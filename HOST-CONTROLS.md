...
> Historical v2.3 update notes. The current v2.4 package and its changed missing-room behavior are described in **JOIN-OR-CREATE.md**.
...
and a new smoothing benchmark were not tested. See **TESTING.md** and
