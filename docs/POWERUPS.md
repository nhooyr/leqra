...
> Current rules: friendly fire is optional; **Machine gun, Shotgun and Laser never damage their own shooter**. Other returning shells/missiles and grenade blasts can. See [UPDATE-v4.27.0.md](releases/UPDATE-v4.27.0.md) for current timing, survival and bot changes.
...
same collision model. See [UPDATE-v4.1.md](releases/UPDATE-v4.1.md) for details.
...
Current upgrade instructions and test limitations: [UPDATE-v4.1.md](releases/UPDATE-v4.1.md) and [TESTING.md](TESTING.md).
