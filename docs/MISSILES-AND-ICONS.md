...
> Historical v2.8 release notes. The icons and range rules remain; [UNIFIED-ROOMS.md](UNIFIED-ROOMS.md) and [POWERUPS.md](POWERUPS.md) describe the stronger v3.0 missile tuning and teams.
