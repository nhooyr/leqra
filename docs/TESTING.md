# leqra v4.43.0 — current verification

See [TEST-NOTES-v4.43.0.md](releases/TEST-NOTES-v4.43.0.md) for the recorded release results and limitations. Current raw logs are in `src/tests/results/v4.43.0/`. Archived reports preserve the paths used when they were written; use the commands below for the current repository layout.
