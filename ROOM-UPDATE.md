...
> Historical v2.2 update notes. The current v2.4 package and its changed missing-room behavior are described in **JOIN-OR-CREATE.md**.
...
tested. The previous smoothing benchmarks were not remeasured. See **TESTING.md**
